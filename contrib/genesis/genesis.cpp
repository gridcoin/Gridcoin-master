...
Transaction *InitTransaction()
{
		...
		transaction->sequence = 4294967295;
...
int main(int argc, char *argv[])
{
		...
		if (1==1 || argv[2]=="create") {
			//argv[2] = "NY Times 05/Oct/2011 Steve Jobs, Apple’s Visionary, Dies at 56";
			    fprintf(stderr, "Creating!\n");
argv[2] = "123";
			
            argv[1] = "040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9";
			argv[3] = "486604799";
  ...
  //     hash2="97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9";

        // This copy isn't necessary imo, but here for clarity
        memcpy(transaction->merkleHash, hash2, 32);
       
    char *merkleHash1 = bin2hex(transaction->merkleHash, 32);
	//char *merkleHash = "97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9";

        byteswap(transaction->merkleHash, 32);
        char *merkleHashSwapped1 = bin2hex(transaction->merkleHash, 32);
      char *txScriptSig = bin2hex(transaction->scriptSig, scriptSig_len);

		//char *txScriptSig = "04ffff001d0104404e592054696d65732030352f4f63742f32303131205374657665204a6f62732c204170706c65e280997320566973696f6e6172792c2044696573206174203536";
	  //Swap these two??
	  char *merkleHash = merkleHashSwapped1;
	  char *merkleHashSwapped = merkleHash1;

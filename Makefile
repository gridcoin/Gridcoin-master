...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Wed Oct 16 22:11:48 2013
# Project:  bitcoin-qt.pro
# Template: app
# Command: c:/Qt/4.8.5/bin/qmake.exe BOOST_INCLUDE_PATH=libs/boost_1_54_0 BOOST_LIB_PATH=libs/boost_1_54_0/stage/lib BOOST_LIB_SUFFIX=-mgw46-mt-1_54 OPENSSL_INCLUDE_PATH=libs/openssl-1.0.1e/include OPENSSL_LIB_PATH=libs/openssl-1.0.1e BDB_INCLUDE_PATH=libs/db-4.8.30.NC/build_unix BDB_LIB_PATH=libs/db-4.8.30.NC/build_unix MINIUPNPC_INCLUDE_PATH=libs/miniupnpc-1.8 MINIUPNPC_LIB_PATH=libs/miniupnpc-1.8 "QMAKE_CXXFLAGS=-fno-guess-branch-probability -frandom-seed=1984 -Wno-unused-variable -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing" "QMAKE_CFLAGS=-fno-guess-branch-probability -frandom-seed=1984 -Wno-unused-variable -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing" -o Makefile bitcoin-qt.pro
#############################################################################
...
Makefile: bitcoin-qt.pro  ../Qt/4.8.5/mkspecs/default/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
		...
		../Qt/4.8.5/mkspecs/features/win32/qaxcontainer.prf \
		...
		c:/Qt/4.8.5/lib/QAxContainer.prl
...
clean: debug-clean release-clean FORCE
	-$(DEL_FILE) C:/Gridcoin-master/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/Gridcoin-master/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/Gridcoin-master/src/leveldb/libleveldb.a: FORCE
	cd C:/Gridcoin-master/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-fno-guess-branch-probability -frandom-seed=1984 -Wno-unused-variable -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/Gridcoin-master/src/leveldb/libleveldb.a && ranlib C:/Gridcoin-master/src/leveldb/libmemenv.a

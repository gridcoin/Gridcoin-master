...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Fri Mar 14 19:04:36 2014
# Project:  bitcoin-qt.pro
# Template: app
# Command: c:/qt/4.8.4/bin/qmake.exe BOOST_INCLUDE_PATH=libs/boost_1_54_0 BOOST_LIB_PATH=libs/boost_1_54_0/stage/lib BOOST_LIB_SUFFIX=-mgw46-mt-1_54 OPENSSL_INCLUDE_PATH=libs/openssl-1.0.1e/include OPENSSL_LIB_PATH=libs/openssl-1.0.1e BDB_INCLUDE_PATH=libs/db-4.8.30.NC/build_unix BDB_LIB_PATH=libs/db-4.8.30.NC/build_unix MINIUPNPC_INCLUDE_PATH=libs/miniupnpc-1.8 MINIUPNPC_LIB_PATH=libs/miniupnpc-1.8 "QMAKE_CXXFLAGS=-fno-guess-branch-probability -frandom-seed=1984 -Wno-unused-variable -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing" "QMAKE_CFLAGS=-fno-guess-branch-probability -frandom-seed=1984 -Wno-unused-variable -Wno-unused-value -Wno-sign-compare -Wno-strict-aliasing" USE_QRCODE=1 -o Makefile bitcoin-qt.pro
#############################################################################

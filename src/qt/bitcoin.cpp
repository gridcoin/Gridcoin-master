...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Gridcoin");
    QApplication::setOrganizationDomain("gridcoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Gridcoin-Qt-testnet");
    else
        QApplication::setApplicationName("Gridcoin-Qt");

    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a Gridcoin address (e.g. Ger4HNAEfwYhBmGXcFP2Po1NpRUEiK8km2)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a Gridcoin address (e.g. Ger4HNAEfwYhBmGXcFP2Po1NpRUEiK8km2)"));

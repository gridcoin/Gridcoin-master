...
//
//  for Qt is very similar, only it uses a QTimer to
// fRequestwn getting set, and then does the normal Qt
//  thing.
//
...
//	threadGroup.create_thread(boost::bind(&TraceThread<void (*)()>, "detectshutdown", &DetectShutdownThread));
    ...
    printf("Made it through this mess");
    if (fRet) printf("fRet is true");
    Shutdown();
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: gridcoin.conf)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Gridcoin Wiki for SSL setup instructions)") + "\n" +
